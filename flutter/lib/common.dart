...
class MyTheme {
  ...
  static const Color accent = Color(0xFF52A74C);
  static const Color accent50 = Color(0x7752A74C);
  static const Color accent80 = Color(0xAA52A74C);
  ...
  static const Color button = Color(0xFF52A74C);
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    colorScheme: ColorScheme.light(
        primary: Color(0xFF52A74C), secondary: accent, background: grayBg),
...
Widget loadPowered(BuildContext context) {
  ...
  return MouseRegion(
    ...
    child: GestureDetector(
      onTap: () {
        launchUrl(Uri.parse('https://www.simplificacao.com'));
      },
      child: Opacity(
          opacity: 0.5,
          child: Text(
